...
namespace NWebDav.Server {
    ...
    public class WebDavDispatcher : IWebDavDispatcher {
        ...
        static WebDavDispatcher() {
            Console.WriteLine($"[webdav] WebDavDispatcher");
            ...
            Console.WriteLine($"[webdav] WebDavDispatcher {assemblyVersion}");
            s_serverName = $"NWebDav/{assemblyVersion}";
            Console.WriteLine($"[webdav] WebDavDispatcher {s_serverName}");
        }
        ...
        public WebDavDispatcher(IStore store, IRequestHandlerFactory requestHandlerFactory = null) {
            ...
            if (store == null) {
                Console.WriteLine($"[webdav] WebDavDispatcher ArgumentNullException");
        ...
        public async Task DispatchRequestAsync(IHttpContext httpContext) {
            ...
            if (httpContext == null) {
                Console.WriteLine($"[webdav] WebDavDispatcher httpContext == null");
            ...
            if (request == null) {
                Console.WriteLine($"[webdav] WebDavDispatcher request == null");
            ...
            if (response == null) {
                Console.WriteLine($"[webdav] WebDavDispatcher response == null");
            ...
            try {
                ...
                try {
                    ...
                    Console.WriteLine($"[webdav] WebDavDispatcher");
                    Console.WriteLine($"[webdav] {exc.ToString()}");
                    // Log error
