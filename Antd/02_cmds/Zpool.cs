...
namespace Antd.cmds {
    public class Zpool {
        ...
        private const string zpoolFileLocation = "/sbin/zpool";
        ...
        public static bool Import(string poolName) {
            CommonProcess.Do(zpoolFileLocation, CommonString.Append(zpoolImportPoolArgs, poolName, " ", poolName).Replace("//", "/"));
            return true;
        }

        public static string[] History() {
            return CommonProcess.Execute(zpoolFileLocation, zpoolHistory).ToArray();
        }
    }
}
