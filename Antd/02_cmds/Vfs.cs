    ...
    public class Vfs {
        ...
        public static void SetDefaults() {
            if(!File.Exists(_systemFile)) {
                File.WriteAllText(_systemFile, JsonConvert.SerializeObject(new Defaults.DefaltSystem(), Formatting.Indented));
                File.WriteAllText(_apiKeyFile, JsonConvert.SerializeObject(new List<Defaults.ApiKey>() { new Defaults.ApiKey() }, Formatting.Indented));
                File.WriteAllText(_apiKeyPermissionFile, JsonConvert.SerializeObject(new List<Defaults.ApiKeyPermission>() { new Defaults.ApiKeyPermission() }, Formatting.Indented));
                File.WriteAllText(_userMasterFile, JsonConvert.SerializeObject(new List<Defaults.UserMaster>() { new Defaults.UserMaster() }, Formatting.Indented));
                File.WriteAllText(_topologyFile, JsonConvert.SerializeObject(new Defaults.ListTopology(), Formatting.Indented));
            }
        }
