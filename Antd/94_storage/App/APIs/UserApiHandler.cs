...
namespace Kvpbase {
    public partial class StorageServer {
        public static HttpResponse UserApiHandler(RequestMetadata md) {
            ...
            switch(md.CurrentHttpRequest.Method.ToLower()) {
                ...
                default:
                    ...
                    ConsoleLogger.Warn("UserApiHandler unknown HTTP method '" + md.CurrentHttpRequest.Method + "'");
            ...
            ConsoleLogger.Warn("UserApiHandler unknown URL " + md.CurrentHttpRequest.RawUrlWithoutQuery);
