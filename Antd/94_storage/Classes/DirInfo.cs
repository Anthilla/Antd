...
namespace Kvpbase {
    public class DirInfo {
        ...
        public DirInfo(Settings settings, UserManager users) {
            if(settings == null)
        ...
        public DirInfo FromDirectory(string directory, string userGuid, int maxResults, List<SearchFilter> filters, bool metadataOnly) {
            ...
            foreach(string curFile in fileList) {
                        ...
                        foreach(SearchFilter currFilter in filters) {
                            ...
                            switch(currFilter.Field) {
                                case "Name":
                                    ...
                                    if(String.IsNullOrEmpty(currFilter.Condition))
                                        continue;
                                    if(String.IsNullOrEmpty(currFilter.Value))
                                        continue;

                                    switch(currFilter.Condition) {
                                        case "Equal":
                                            if(String.Compare(currFilter.Value.ToLower().Trim(), currObjInfo.Key.ToLower().Trim()) == 0)
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                        ...
                                        case "StartsWith":
                                            if(currObjInfo.Key.ToLower().Trim().StartsWith(currFilter.Value.ToLower().Trim()))
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                        ...
                                        case "EndsWith":
                                            if(currObjInfo.Key.ToLower().Trim().EndsWith(currFilter.Value.ToLower().Trim()))
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                        ...
                                        case "Contains":
                                            if(currObjInfo.Key.ToLower().Trim().Contains(currFilter.Value.ToLower().Trim()))
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                ...
                                case "Size":
                                    ...
                                    switch(currFilter.Condition) {
                                        case "GreaterThan":
                                            if(currObjInfo.Size > filterSize)
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                ...
                                case "Created":
                                    ...
                                    switch(currFilter.Condition) {
                                        case "GreaterThan":
                                            if(DateTime.Compare(Convert.ToDateTime(currObjInfo.Created), createdTs) > 0)
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                ...
                                case "LastUpdate":
                                    ...
                                    switch(currFilter.Condition) {
                                        case "GreaterThan":
                                            if(DateTime.Compare(Convert.ToDateTime(currObjInfo.LastUpdate), lastUpdateTs) > 0)
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                ...
                                case "LastAccess":
                                    ...
                                    switch(currFilter.Condition) {
                                        case "GreaterThan":
                                            if(DateTime.Compare(Convert.ToDateTime(currObjInfo.LastAccess), lastAccessTs) > 0)
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                                ...
                                case "Contents":
                                    ...
                                    switch(currFilter.Condition) {
                                        case "Contains":
                                            ...
                                            if(String.IsNullOrEmpty(currObjContents))
                                                continue;

                                            if(currObjContents.ToLower().Contains(currFilter.Value.ToLower()))
                                                filterMatch = true;
                                            else
                                                filterMatch = false;
                                            break;
                ...
                if(!metadataOnly)
                    ret.ObjectMetadata.Add(currObjInfo);
