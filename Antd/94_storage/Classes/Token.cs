    ...
    public class Token {
        ...
        public static bool VerifyToken(
            ...
            try {
                ...
                ConsoleLogger.Warn( "VerifyToken unable to deserialize request body");
                return false;
            }
            ...
            if(!Common.IsLaterThanNow(curr.Expiration)) {
                ConsoleLogger.Warn( "VerifyToken token expired at " + curr.Expiration);
                return false;
            }
            ...
            if(currUser == null) {
                ConsoleLogger.Warn( "VerifyToken unable to find UserMasterId " + curr.UserMasterId);
                return false;
            }
            ...
            if(currUser.Active == 1) {
                if(Common.IsLaterThanNow(currUser.Expiration)) {
                    ...
                    ConsoleLogger.Warn( "VerifyToken UserMasterId " + currUser.UserMasterId + " expired at " + curr.Expiration);
                    return false;
                }
            }
            else {
                ConsoleLogger.Warn( "VerifyToken UserMasterId " + currUser.UserMasterId + " marked inactive");
                return false;
            }
