...
namespace Antd.Configuration {
    public class MachineConfiguration {
        ...
        private static readonly BootModuleLoadRepository BootModuleLoadRepository = new BootModuleLoadRepository();
        private static readonly BootServiceLoadRepository BootServiceLoadRepository = new BootServiceLoadRepository();
        private static readonly BootOsParametersLoadRepository BootOsParametersLoadRepository = new BootOsParametersLoadRepository();
        ...
        public static void Set() {
            ...
            BootModuleLoadRepository.Dump(configuration.LoadModules);
            BootServiceLoadRepository.Dump(configuration.LoadServices);
