...
namespace Antd {
    public class SyncFromRemoteServerJob : Job {
        ...
        public override void DoJob() {
            if(Application.CurrentConfiguration.TimeDate.SyncFromRemoteServer &&
                Application.CurrentConfiguration.TimeDate.RemoteNtpServer != string.Empty) {
                Timedatectl.SetNtpdate(Application.CurrentConfiguration.TimeDate.RemoteNtpServer);
            }
        }
    }
}
