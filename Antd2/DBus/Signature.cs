...
namespace Antd.DBus {
    ...
    public struct Signature {
        ...
        internal static byte[] DataForDType(DType value) {
            switch (value) {
                case DType.Byte:
                    return ByteSig._data;
                case DType.Boolean:
                    return BoolSig._data;
                case DType.Int16:
                    return Int16Sig._data;
                case DType.UInt16:
                    return UInt16Sig._data;
                case DType.Int32:
                    return Int32Sig._data;
                case DType.UInt32:
                    return UInt32Sig._data;
                case DType.Int64:
                    return Int64Sig._data;
                case DType.UInt64:
                    return UInt64Sig._data;
                case DType.Single:
                    return SingleSig._data;
                case DType.Double:
                    return DoubleSig._data;
                case DType.String:
                    return StringSig._data;
                case DType.ObjectPath:
                    return ObjectPathSig._data;
                case DType.Signature:
                    return SignatureSig._data;
                case DType.Array:
                    return ArraySig._data;
                case DType.Variant:
                    return VariantSig._data;
                case DType.StructBegin:
                    return StructBeginSig._data;
                case DType.StructEnd:
                    return StructEndSig._data;
                case DType.DictEntryBegin:
                    return DictEntryBeginSig._data;
                case DType.DictEntryEnd:
                    return DictEntryEndSig._data;
                default:
