...
[assembly: InternalsVisibleTo(Antd.DBus.Connection.DynamicAssemblyName)]

namespace Antd.DBus.CodeGen {
    internal class DynamicAssembly {
        ...
        private DynamicAssembly() {
            _assemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(Antd.DBus.Connection.DynamicAssemblyName), AssemblyBuilderAccess.Run);
            _moduleBuilder = _assemblyBuilder.DefineDynamicModule(Antd.DBus.Connection.DynamicAssemblyName);
