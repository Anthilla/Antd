                ...
                var FileUploader = function () {
                    ...
                    */
                    ...
                    FileUploader.prototype._xhrTransport = function _xhrTransport(item) {
                        ...
                        var timeoutVal = 3600000; //3600000
                        xhr.timeout = timeoutVal;
                        xhr.ontimeout = function () {
                            xhr.isError = true;
                            xhr.progress = 0;
                            console.error("upload timeout after " + timeoutVal);
                        };
                    ...
                    FileUploader.prototype._onCompleteItem = function _onCompleteItem(item, response, status, headers) {
                        ...
                        //FIX
                        var nextItems = this.getReadyItems();
                        var nextItem = this.getReadyItems()[0];
                        //console.info("all items", this.getReadyItems());
                        //console.info("nextItem", nextItem);
                        this.isUploading = false;

                        if (isDefined(nextItem)) {
                            //console.info("isdefined", item);
                            nextItem.upload();
                            return;
                        }
