...
app.controller("RequestMaterialSanitaryControllerDashboard", ["$rootScope", "$scope", "$http", RequestMaterialSanitaryControllerDashboard]);

function RequestMaterialSanitaryControllerDashboard($rootScope, $scope, $http) {
    $scope.Create = function (el) {
        ...
        $http.post("/repo/requestmaterialsanitary", data).then(
            function () {
                $scope.Ward = null;
                $scope.Nurse = null;
                $rootScope.$broadcast("RequestMaterialSanitaryDashboardSave");
            },
        function (response) {
...
app.controller("RequestMaterialSanitaryControllerContent", ["$rootScope", "$scope", "$http", RequestMaterialSanitaryControllerContent]);

function RequestMaterialSanitaryControllerContent($rootScope, $scope, $http) {
    ...
    $scope.SaveFile = function (file) {
        ...
        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
        $http.post("/repo/requestmaterialsanitary/save", data).then(
            function () {
                $http.get("/repo/requestmaterialsanitary").success(function (data) {
                    $scope.files = data;
                });
            },
        function (response) {
    ...
    $scope.SubmitFile = function (file) {
        ...
        $http.post("/repo/requestmaterialsanitary/save", data).then(
            function () {
                ...
                $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
                $http.post("/repo/requestmaterialsanitary/submit", data).then(
                    function () {
                        $http.get("/repo/requestmaterialsanitary").success(function (data) {
                            $scope.files = data;
                        });
    ...
    $http.get("/cache/material_sanitary").success(function (data) {
    ...
    $scope.$on("RequestMaterialSanitaryDashboardSave", function () {
        $http.get("/repo/requestmaterialsanitary").success(function (data) {
            $scope.files = data;
        });
    });
    ...
    $scope.CompleteTask = function (file) {
        ...
        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
        $http.post("/repo/requestmaterialsanitary/archive", data).then(
            function () {
                $http.get("/repo/requestmaterialsanitary").success(function (data) {
                    $scope.files = data;
                });
    ...
    $scope.DeleteFile = function (file) {
        ...
        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
        $http.post("/repo/requestmaterialsanitary/delete", data).then(
            function () {
    ...
    $scope.RejectFile = function () {
        ...
        $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
        $http.post("/repo/requestmaterialsanitary/edit/status", data).then(
            function () {
                $http.get("/repo/requestmaterialsanitary").success(function (data) {
                    $scope.files = data;
                });
